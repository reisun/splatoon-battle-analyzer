...
（0にするとノックアウト=カウントが少ない方が勝っている）
- ゲームカウントの下: ペナルティ。カウントをとってもペナルティが先に減る=ゲームカウントを減らせない
...
JSONのみで回答してください:
{"kills": 1, "assists": 1, "score_gain": 1, "special": 1, "is_dead": false, "my_team_color": "自チームの色", "enemy_team_color": "相手チームの色", "my_team_score": null, "enemy_team_score": null, "description": "現在の状況の説明"}
スコアは全て1-10。不明なら1。is_deadはtrue/false。チームスコアが不明ならnull。"""
