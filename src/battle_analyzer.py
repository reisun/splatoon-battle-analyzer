...
- ゲームカウント回りの小さな数字: ゲームごとに仕様が異なるため割愛。無視する
...
- score_gain: 自チームのゲームカウントが目立って増加しているか？
- special: スペシャルウェポンが発動中、またはその効果が見えるか？
- is_dead: 自プレイヤーがデス中か？（画面が暗転・復帰待ち状態ならtrue）

JSONのみで回答してください:
{"kills": 1, "assists": 1, "score_gain": 1, "special": 1, "is_dead": false, "my_team_color": "自チームの色", "enemy_team_color": "相手チームの色", "my_team_count": null, "enemy_team_count": null, "description": "現在の状況の説明"}
